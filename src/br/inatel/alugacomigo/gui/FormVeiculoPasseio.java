...
public class FormVeiculoPasseio extends javax.swing.JFrame {
    ...
    private boolean camposVazios() {
        ...
        if (campoMarca.getText().equals("")
                ...
                || campoCargaPassageiros.getText().equals("")
    ...
    private void preencherClasse(){
        ...
        ((VeiculoPasseio) veiculo).setCapacidadePassageiros(Integer.parseInt(campoCargaPassageiros.getText()));
        ((VeiculoPasseio) veiculo).setCapacidadeBagageiro(Integer.parseInt(campoCargaL.getText()));
    ...
    private void preencherCampos() {
        ...
        campoCargaL.setText(String.valueOf(((VeiculoPasseio) veiculo).getCapacidadeBagageiro()));
        campoCargaPassageiros.setText(String.valueOf(((VeiculoPasseio) veiculo).getCapacidadePassageiros()));
    ...
    private void limpar() {
        ...
        campoCargaPassageiros.setText(null);
    ...
    private void initComponents() {
        ...
        campoCargaPassageiros = new javax.swing.JTextField();
        ...
        campoCargaPassageiros.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        ...
        labelUsuario1.setText("Capacidade de Passageiros:");
                            ...
                            .addGroup(painelFormularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(painelFormularioLayout.createSequentialGroup()
                                    ...
                                    .addGroup(painelFormularioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(campoCargaPassageiros)))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormVeiculoPasseio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormVeiculoPasseio().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField campoCargaPassageiros;
